...
const SideProjects = () => {
    return (
        <div className={classes.SideProjectsContainer}>
            ...
            <div className={classes.SideProjectItemLeft}> <a href='https://github.com/epicoding95/chat-room'>Chat Room</a><img src={require('../../assets/images/newimage.png')} alt='codeimage' /> <p> Application in which you can log in and immediately join the greatest conversation on earth. Built with React/Node.js/Socket.io/Material-UI</p></div>
            ...
            <div className={classes.SideProjectItemRight}> <a href='https://github.com/epicoding95/redasForgetfulList'>Redas Forgetful List</a><img src={require('../../assets/images/newimage.png')} alt='codeimage' /> <p> A web app built so you and I both can stop forgetting things at the store. Built with React/Material-UI</p></div>
        </div>
    );
};
