...
const WorkInfoCard = props => {
    ...
    return (
        <div ref={ref} id='Work'>
            <div id='first' className={inView ? classes.CardContainerOne : classes.MainContainerPlaceHolder} data-aos='fade-left'>
                <p>Replenium</p>
            ...
            <div ref={ref} id='second' className={inView ? classes.CardContainerTwo : classes.MainContainerPlaceHolder} data-aos='fade-right'>
                <p>Replenium</p>
                <p>Intern</p>
            ...
            <div ref={ref} id='third' className={inView ? classes.CardContainerThree : classes.MainContainerPlaceHolder} data-aos='fade-left'>
                <p>UPS</p>
